    ...
    const handlefetchPayments = async () => {
      try {
        const res = await fetch(
          `${process.env.REACT_APP_APP_URL}/getPayments`,
          {
            method: "GET",
            headers: {
        ...
        if (res.ok) {
          const vendorPayment = data.filter(
            (payment) => payment.paymentTo === "Logistic",
          );
          setPayment(vendorPayment);
        }
      } catch (error) {
        console.log(error);
      }
              ...
              <tbody>
                {
                  ...
                  <tr key={order.transactionId}>
                    ...
                    <td>
                      ...
                      <span>Currently there is no history</span>
                  )
                }
              </tbody>
            </table>
...
export default LogisticPayments;
