                ...
                .bind((e) => {
                  ...
                  if (r.length > 0) {
                    if (o) return I.some(xh.partialTable(r, I.none()));
                    {
                      const e = Oh(n, t);
                      return I.some(
                        xh.partialTable(r, I.some({ ...t, rng: e })),
                      );
                    }
                  }
                  return I.none();
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                vb(
                  ...
                  (n) =>
                    ue(t, (t) =>
                      ((t, n) => (Eb(e, t.dom, n) ? I.some(n) : I.none()))(
                        n,
                        t,
                      ),
                    ),
            ...
            : (t && ir(o.getNode())) || (!t && ir(o.getNode(!0)))
              ? ((e, t, n, o) => {
                  ...
                  return ph(yn(e), yn(n.getNode()))
                    .map((e) =>
                      bs(e) ? yx.remove(e.dom) : yx.moveToElement(r),
                    )
