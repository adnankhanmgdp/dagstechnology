...
var walletOptions,
  walletBalanceColors = getChartColorsArray("wallet-balance-chart");
walletBalanceColors &&
  ((walletOptions = {
    series: [76, 67, 61],
    chart: { height: 302, type: "radialBar" },
    plotOptions: {
      radialBar: {
        offsetY: 0,
        startAngle: 0,
        ...
        dataLabels: {
          name: { show: !0, fontSize: "16px", fontWeight: 600, offsetY: -10 },
          value: {
            show: !0,
            fontSize: "14px",
            offsetY: 4,
  ...
  (chart = new ApexCharts(
    document.querySelector("#wallet-balance-chart"),
    walletOptions,
  )).render());
var options,
  chart,
  overviewTimelineColors = getChartColorsArray("overview-chart-timeline");
overviewTimelineColors &&
  ((options = {
    series: [
      {
        name: "BTC",
  ...
  (chart = new ApexCharts(
    document.querySelector("#overview-chart-timeline"),
    options,
  )).render());
...
document.querySelector("#one_month").addEventListener("click", function (e) {
  ...
  document.querySelector("#all").addEventListener("click", function (e) {
    resetCssClasses(e),
      chart.updateOptions({ xaxis: { min: void 0, max: void 0 } });
  });
