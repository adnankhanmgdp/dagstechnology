...
var options,
  chart,
  donutchartColors = getChartColorsArray("donut-chart");
donutchartColors &&
  ((options = {
    series: [56, 38, 26],
...
var radialoptions1,
  radialchart1,
  radialChartColors = getChartColorsArray("radialchart-1");
radialChartColors &&
  ((radialoptions1 = {
    series: [37],
    chart: {
  ...
  (radialchart1 = new ApexCharts(
    document.querySelector("#radialchart-1"),
    radialoptions1,
  )).render());
var radialoptions2,
  radialchart2,
  radialChart1Colors = getChartColorsArray("radialchart-2");
radialChart1Colors &&
  ((radialoptions2 = {
    series: [72],
    chart: {
  ...
  (radialchart2 = new ApexCharts(
    document.querySelector("#radialchart-2"),
    radialoptions2,
  )).render());
var radialoptions3,
  radialchart3,
  radialChart3Colors = getChartColorsArray("radialchart-3");
radialChart3Colors &&
  ((radialoptions3 = {
    series: [54],
    chart: {
